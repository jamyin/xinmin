...
import com.ssic.xinmin.utils.dto.DateDto;
...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static final String[] weekDays = { "日", "一", "二", "三", "四",
			"五", "六" };
	public static final String[] weekDaysOf = { "7", "1", "2", "3", "4", "5",
			"6" };
	...
	public static List<DateDto> queryDayAndWeek(Date date, int offset)
			throws Exception {
